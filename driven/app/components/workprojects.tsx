...
const Projects = () => {
  ...
  const categories = ['All Projects', 'UI/UX', 'Development', 'App'];
    ...
    <div className='container py-[60px] z-5 bg-[#e8e8e8] relative block md:py-[80px]'>
        <div className='flex flex-col items-center max-w-[1200px] mx-auto px-[15px] relative'>
            <div className='w-full'>
                  <div className='flex gap-y-[15px] flex-col items-center justify-between mb-[50px] relative md:flex-row lg:justify-start'>
                        {categories.map((category, index) => (
                            <a 
                                ...
                                className={`text-center w-full px-0 block relative max-w-full px-[20px] text-[30px] lg:text-[35px] leading-[1.2em] uppercase no-underline bg-transparent cursor-pointer align-top items-center transition-all duration-300 lg:w-auto ${index === 0 ? 'lg:mr-auto' : ''} ${
                                    activeCategory === category 
                                    ? 'text-[#7000ff]' 
                                    : index === 0 
                                    ? 'text-black'
                                    : 'text-transparent [-webkit-text-stroke-width:1.3px] [-webkit-text-stroke-color:#7000ff]'
                                }`}
                            >
                                <div>{category}</div>
                            </a>
