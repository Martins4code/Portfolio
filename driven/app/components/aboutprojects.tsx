                        ...
                        <div>
                                  <div className='flex gap-[50px] flex-col justify-between'>
                                           ...
                                           {/* writings x tag */}
                                                    ...
                                                    Fashion Landing Page for Wally
                                                        ...
                                                        <div> 
                                                            <div className='flex gap-5'>
                                                                    <div>
                                                                         <a href="" onClick={(e) => e.preventDefault()} className="border-2 border solid border-[#7000ff] text-[#111] rounded-[80px] py-2.5 px-5 leading-[1em] inline-block items-center text-[20px] no-underline bg-[#0000] transition-[background-color,color] duration-300 hover:bg-[#7000ff] hover:text-white focus:bg-[#7000ff] focus:text-white">
                                                                            UI/UX
                                                                        </a>
                                                                    </div>
                                                                    <div>
                                                ...
                                                <a href="#" onClick={(e) => e.preventDefault()} className="w-[100px] h-[100px] rounded-full border-3 border-solid border-[#7000ff] flex max-w-full items-center justify-center text-[20px] leading-[1.2em] no-underline bg-[#0000] transition:-colors duration-300 hover:bg-[#7000ff] hover:text-white group"
                                                    ...
                                                    <Image 
                                                        ...
                                                        width={28} 
                                                        height={40} 
                                                        className="text-[#7000ff] max-w-full inline-block align-middle border-0 group-hover:text-white transition-all duration-500 transform -rotate-45 group-focus:rotate-[-135deg]" 
                                                    />
                                                ...
                                                <div className='flex flex-col gap-y-2.5'>
                                                    ...
                                                    Fashion Landing Page for Wally
                                                        ...
                                                        <div> 
                                                            <div className='flex gap-5'>
                                                                    <div>
                                                                         <a href="" onClick={(e) => e.preventDefault()} className="border-2 solid border-[#7000ff] text-[#111] rounded-[80px] py-2.5 px-5 leading-[1em] inline-block items-center text-[20px] no-underline bg-[#0000] transition-[background-color,color] duration-300 hover:bg-[#7000ff] hover:text-white focus:bg-[#7000ff] focus:text-white">
                                                                            UI/UX
                                                                        </a>
                                                                    </div>
                                                                    <div>
