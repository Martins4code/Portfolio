...
const Services = () => {
  return (
    <div className='py-20 overflow-hidden block z-5 bg-[#111] relative'>
        <div className='flex flex-col items-center max-w-[1200px] mx-auto px-[15px] relative'>
            <div className='grid grid-cols-1 gap-[30px] auto-cols-fr w-full lg:grid-cols-3 '>
              ...
              {/* --- HEADER SECTION --- */}
              <div className='flex flex-col w-full p-[30px] rounded-[15px] bg-white gap-x-0 col-span-1 row-span-1 mb-0 opacity-100 gap-[30px] items-center lg:items-start  gap-y-[30px]'>
              ...
              <div className='col-span-1 row-span-1 w-full lg:col-span-2'>
                  <div className='flex flex-col gap-[30px] lg:flex-row h-full'>
                        <ServiceCard index={3} baseColor="bg-[#222] border border-[#7010ff]" overlayColor="bg-[#7000ff]">
                                      <div className='w-full relative'>
