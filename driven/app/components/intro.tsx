...
const Intro = () => {
  return (
    <div className='container mx-auto px-9 py-8 bg-gray-200 min-h-screen overflow-y-hidden'>


      <div className="flex flex-row lg:flex-row lg:justify-between lg:items-end">
        
        <div className="w-full lg:w-auto">
          <p className='text-[40px] lg:text-[80px] m-0 leading-tight'>CREATIVE</p>
          
         
          <div className='flex flex-col lg:flex-row items-start lg:items-end'>
            
        
            <div className="relative w-[163px] h-[50px] lg:w-[227px] lg:h-[70px] shrink-0 mt-2 lg:mt-0">
                <Image
                src='/icons/UX_UX.svg'
                alt='ui/ux'
                fill
            ...
            <p className='text-[40px] lg:text-[80px] pt-0 pl-0 lg:pt-[20px] lg:pl-[20px] leading-tight'>
              DESIGNER
            </p>
          </div>
        ...
        <div className='mt-2 lg:mt-[40px] group self-end lg:self-auto'>
          <div className='w-[8.5rem] h-[8.5rem] ml-[4px] lg:w-[13rem] lg:h-[13rem] border-4 lg:border-5 border-violet-600 rounded-full flex items-center justify-center p-2 transition-transform hover:scale-105'>
            <Image
        ...
        <div className="order-2 w-full lg:w-auto flex flex-col lg:ml-auto space-y-6">
          <div className="flex flex-row gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-3 border-2 border-violet-600 text-violet-600 rounded-full overflow-hidden w-[50px] hover:w-[140px] lg:hover:w-[150px] hover:bg-violet-600 hover:text-white transition-all duration-300 px-2 py-2"
            >
