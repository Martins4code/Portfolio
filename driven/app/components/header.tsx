...
const Header = () => {
  ...
  return (
    <div className="bg-[#e8e8e8] w-full py-[15px] relative z-1000">
      {/* --- DESKTOP NAVIGATION --- */}
      {/*2nd*/}
      <div className="flex px-[15px] justify-between items-center max-w-[1750px] mx-auto">
      {/*3rd*/}
              <div className="flex gap-x-[15px] flex-1 justify-between items-center">
                  <div className="hidden lg:flex w-full items-center justify-between px-[15px] py-[15px] relative z-50 bg-[#e8e8e8]">
                    
                      <a href="/" className="pl-0 float-left text-[#333] no-underline relative items-center text-[20px] leading-[1.2em] transition-colors duration-300 bg-[#0000]">
      ...
      <div className="z-1 top-0 right-0 w-auto hidden absolute left-0 overflow-hidden"></div> 
